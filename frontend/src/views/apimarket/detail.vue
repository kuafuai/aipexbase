<template>
  <div class="p-6">
    ...
    <div v-loading="loading" class="max-w-4xl">
      ...
      <div class="bg-white/5 backdrop-blur-md rounded-2xl p-8 border border-white/10 mb-6">
        <div class="flex items-start justify-between mb-6">
          ...
          <div class="flex items-center space-x-2">
            ...
            <el-button
                class="border-red-500/30 text-red-400 hover:bg-red-600/30"
                @click="deleteApi"
            >
      ...
      <!-- 请求体 -->
      <div v-if="apiInfo.bodyTemplate" class="bg-white/5 backdrop-blur-md rounded-2xl p-8 border border-white/10 mb-6">
