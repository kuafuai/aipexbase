    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
          {{ t('page.project_detail.page_title') }}
        </h1>
        <p class="text-white/60 mt-2">{{ t('page.project_detail.page_sub') }}</p>
      </div>
    ...
    <div class="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden">
      <div class="p-6 border-b border-white/10">
        <div class="flex items-center space-x-3">
          ...
          <h2 class="text-xl font-semibold text-cyan-300">{{ t('page.project_detail.card_app_info') }}</h2>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div
            ...
            <div class="flex flex-col items-center text-center">
              ...
              <div class="text-sm text-white/60 mb-2">{{ t('page.project_detail.field_app_name') }}</div>
              <div class="text-lg font-semibold text-white truncate w-full">{{ appOverview.appName || t('page.project_detail.unset') }}</div>
          ...
          <div
            ...
            <div class="flex flex-col items-center text-center">
              ...
              <div class="text-sm text-white/60 mb-2">{{ t('page.project_detail.field_status') }}</div>
              <el-tag
              ...
              >
                {{ appOverview.status || t('page.project_detail.unknown') }}
              </el-tag>
          ...
          <div
            ...
            <div class="flex flex-col items-center text-center">
              ...
              <div class="text-sm text-white/60 mb-2">{{ t('page.project_detail.field_table_count') }}</div>
              <div
    ...
    <div class="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden">
      <div class="p-6 border-b border-white/10">
        <div class="flex items-center space-x-3">
          ...
          <h2 class="text-xl font-semibold text-purple-300">{{ t('page.project_detail.quick_actions') }}</h2>
        </div>
      </div>
      ...
      <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <span class="font-medium">{{ t('page.project_detail.manage_tables') }}</span>
          </el-button>
          ...
          >
            ...
            <span class="font-medium">{{ t('page.project_detail.api_keys') }}</span>
          </el-button>
          ...
          >
            ...
            <span class="font-medium">{{ t('page.project_detail.base_settings') }}</span>
          </el-button>
          ...
          >
            ...
            <span class="font-medium">{{ t('page.project_detail.third_integrations') }}</span>
          </el-button>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden">
      ...
      <div class="p-6 border-b border-white/10">
        <div class="flex items-center space-x-3">
          ...
          <h2 class="text-xl font-semibold text-orange-300">{{ t('page.project_detail.detail_info') }}</h2>
        </div>
      </div>
      ...
      <div class="p-6">
          ...
          <div class="space-y-4">
            ...
            <div
              ...
              <div class="flex items-center space-x-3">
                ...
                <span class="text-white/80">{{ t('page.project_detail.field_app_id') }}</span>
              </div>
            ...
            <div
              ...
              <div class="flex items-center space-x-3">
                ...
                <span class="text-white/80">{{ t('page.project_detail.field_owner') }}</span>
              </div>
            ...
            <div
              ...
              <div class="flex items-center space-x-3">
                ...
                <span class="text-white/80">{{ t('page.project_detail.field_need_auth') }}</span>
              </div>
              <el-tag
              ...
              >
                {{ appOverview.needAuth ? t('page.project_detail.yes') : t('page.project_detail.no') }}
              </el-tag>
            </div>
          ...
          <div class="space-y-4">
            ...
            <div
              ...
              <div class="flex items-center space-x-3">
                ...
                <span class="text-white/80">{{ t('page.project_detail.field_permission') }}</span>
              </div>
              <el-tag
              ...
              >
                {{ appOverview.enablePermission ? t('page.project_detail.enabled') : t('page.project_detail.disabled') }}
              </el-tag>
            </div>
            ...
            <div
              ...
              <div class="flex items-center space-x-3">
                ...
                <span class="text-white/80">{{ t('page.project_detail.field_web_console') }}</span>
              </div>
              <el-tag
              ...
              >
                {{ appOverview.enableWebConsole ? t('page.project_detail.enabled') : t('page.project_detail.disabled') }}
              </el-tag>
            </div>
            ...
            <div
              ...
              <div class="flex items-center space-x-3">
                ...
                <span class="text-white/80">{{ t('page.project_detail.field_auth_table') }}</span>
              </div>
              <span class="text-white font-mono text-sm bg-white/5 px-3 py-1 rounded-lg">{{
        ...
        <div v-if="appOverview.description" class="mt-6 p-4 bg-white/5 rounded-xl border border-white/10">
          <div class="flex items-center space-x-3 mb-3">
            ...
            <div class="text-sm font-medium text-cyan-300">{{ t('page.project_detail.field_description') }}</div>
          </div>
